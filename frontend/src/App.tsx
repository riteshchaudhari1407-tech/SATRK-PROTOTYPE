  ...
  const handleTextScan =
    async () => {
      ...
      try {
        ...
        // Real-time deterministic pattern analysis —
        // every message is independently scored.
        const localData =
          analyzeThreatText(
            textInput
          );

        // Small realistic processing delay so the
        // multi-stage "analysis status" UI reads
        // naturally, scaled to message length.
